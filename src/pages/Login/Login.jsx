    ...
    return (
        <div className=" mx-auto text-center flex flex-col justify-center w-2/4 border my-28 bg-[#ecdbd4] rounded-md">
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5 py-10 w-full justify-center">
                ...
                <input placeholder="Your Name" {...register("name")} className="border-2 outline-primaryColor p-2 w-9/12 mx-auto rounded-md" required />
                <input placeholder="Your Password" {...register("password")} className="border-2 outline-primaryColor p-2 w-9/12 mx-auto rounded-md" required />
            ...
            <div className="">
                ...
                <p className="mx-auto py-5">Don&lsquo;t have an account ? <span className="text-primaryColor">Register Please</span></p>
            </div>
        </div>
    );
};
