...
const MyToysTable = ({ myToy, index,handleDeleteToy }) => {
    const {_id, toyName, toyPhoto, subCategory, price } = myToy;

    return (
            <tr>
                <td className="bg-primaryColor text-white">{index + 1}</td>
                <td>
                ...
                <th>
                    <button onClick={() => handleDeleteToy(_id)} className="btn btn-square bg-primaryColor hover:bg-[#d74c0b] border-none">
